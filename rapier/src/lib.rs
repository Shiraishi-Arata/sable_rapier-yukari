...
pub extern "system" fn JNI_OnLoad(
    ...
    if !is_v2 {
        ...
        let methods = vec![
            ...
            v1nm!("addRotaryConstraint", "(JIIIDDDDDDDDDDDD)J", crate::joints::Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addRotaryConstraint_v2),
            v1nm!("addFixedConstraint", "(JIIIDDDDDDDDDD)J", crate::joints::Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addFixedConstraint_v2),
            v1nm!("addFreeConstraint", "(JIIIDDDDDDDDDD)J", crate::joints::Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addFreeConstraint_v2),
            v1nm!("addGenericConstraint", "(JIIIDDDDDDDDDDDDDDI)J", crate::joints::Java_dev_ryanhcode_sable_physics_impl_rapier_Rapier3D_addGenericConstraint_v2),
